        ...
        <nav className="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                {isActive && (
                  <span className="absolute inset-0 rounded-xl" style={{ background: modoClaro ? "rgba(242,110,29,0.08)" : "rgba(242,110,29,0.12)", border: "1.5px solid rgba(242,110,29,0.40)" }} />
                )}
                {!isActive && (
      ...
      <div className={cn("flex-1 min-h-screen transition-all duration-200", collapsed ? "md:ml-[64px]" : "md:ml-[220px]")}>
        <header className="h-14 flex items-center justify-between px-6 sticky top-0 z-20"
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold" style={{ color: cores.textSecond }}>Painel Administrativo</span>
          </div>
          <div className="flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 ml-2 pl-3" style={{ borderLeft: `1px solid ${cores.border}` }}>
        ...
        <main className="p-6" style={{ minHeight: "calc(100vh - 56px)", backgroundColor: cores.mainBg }}>
