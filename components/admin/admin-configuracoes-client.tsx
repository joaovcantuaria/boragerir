                ...
                <div key={planoId} className="bg-[#1a1a1a] border border-white/10 rounded-2xl p-5 space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      ...
                      className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-3 py-2 text-sm text-white placeholder:text-white/30 focus:outline-none focus:border-primary"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    {[
                      ...
                      <div key={campo} className="space-y-1">
                        ...
                        <input
                          ...
                          className="w-full bg-[#1a1a1a] border border-white/10 rounded-xl px-3 py-2 text-xs text-white focus:outline-none focus:border-primary"
                        />
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 bg-[#1a1a1a] border border-white/10 rounded-lg px-2 py-1.5 text-xs text-white placeholder:text-white/30 focus:outline-none focus:border-primary"
                      />
