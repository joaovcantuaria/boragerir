...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger ref={ref}
    className={cn(
      ...
      "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F26E1D]/40",
      "disabled:pointer-events-none disabled:opacity-50",
      // Inativo
      "text-gray-500 dark:text-gray-400",
      // ATIVO: laranja com texto BRANCO — nunca invisível
      "data-[state=active]:bg-[#F26E1D] data-[state=active]:text-white data-[state=active]:shadow-sm",
      className
    )}
    {...props} />
))
