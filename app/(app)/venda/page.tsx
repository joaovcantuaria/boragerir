...
export default async function VendaPage() {
  ...
  const [
    ...
    supabase.from("produtos_servicos").select("id, nome, tipo, preco, comissao_percentual, estoque_atual, codigo_barras").eq("empresa_id", empresa.id).eq("ativo", true).order("nome"),
