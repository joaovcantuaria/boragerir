...
export default async function CaixaPage() {
  ...
  // Buscar vendas concluídas durante o período dos caixas abertos
  let vendasCaixa: { total: number; forma_pagamento: string }[] = []
  if (caixaPrincipal) {
    const dataAbertura = caixaPrincipal.data_abertura || caixaPrincipal.created_at
