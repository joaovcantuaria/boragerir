              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
                ...
                <div onClick={() => setPlanoSelecionado("agenda")}
                  ...
                  <ul className="space-y-2 flex-1 mb-5">
                    {["Link de agendamento online", "Gestão de agenda completa", "Até 3 colaboradores", "QR Code para clientes", "Módulo de tarefas"].map(r => (
                ...
                <div onClick={() => setPlanoSelecionado("basico")}
                  ...
                  <ul className="space-y-2 flex-1 mb-5">
                    {["Até 200 clientes", "Produtos ilimitados", "Até 3 funcionários", "Gestão de agenda interna", "Relatórios completos", "Contratos e tarefas"].map(r => (
                      <li key={r} className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <div onClick={() => setPlanoSelecionado("profissional")}
                  ...
                  <ul className="space-y-2 flex-1 mb-5">
                    {["Clientes ilimitados", "Funcionários ilimitados", "Agendamento online público", "Link e QR Code de agenda", "Lembretes automáticos", "Programa de fidelidade", "Relatórios avançados", "Contratos e tarefas", "Exportação Excel"].map(r => (
